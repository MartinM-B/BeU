__author__ = 'SARAH'
import pyglet
pyglet.resource.path = ['../resources/sounds','../resources/sounds/new/16bit', '../resources/Viking/halfsize','../resources/Symbiont/halfsize']
...
SpezialLeftMask2 = pyglet.resource.image("Viking_special_left_2_mask.png")
SpezialLeftMask3 = pyglet.resource.image("Viking_special_left_3_mask.png")
SpezialLeftMask4 = pyglet.resource.image("Viking_special_left_4_mask.png")
SpezialLeftMask5 = pyglet.resource.image("Viking_special_left_5_mask.png")

SpezialRightMask2 = pyglet.resource.image("Viking_special_right_2_mask.png")
SpezialRightMask3 = pyglet.resource.image("Viking_special_right_3_mask.png")
SpezialRightMask4 = pyglet.resource.image("Viking_special_right_4_mask.png")
SpezialRightMask5 = pyglet.resource.image("Viking_special_right_5_mask.png")

JumpSound = pyglet.resource.media('jumping.wav', streaming=False)
PunchSound = pyglet.resource.media('viking_punch.wav', streaming=False)
StepSound = pyglet.resource.media('step1.wav', streaming=False)
KickSound = pyglet.resource.media('viking_kick.wav', streaming=False)
SpecialSound = pyglet.resource.media('viking_special.wav', streaming=False)
HitSound = pyglet.resource.media('viking_hit.wav', streaming=False)
