...
class CharSelectState(State, PyClickListener):
    ...
    def initalizeState(self):
        ...
        #chains
        self.chain_sprite1 = pyglet.sprite.Sprite(gui_resources.chain, (self._window.width / 1.5 * 2.0 / 10.0), 0,
                                                  batch=self._batch, group=self._background)
        self.chain_sprite2 = pyglet.sprite.Sprite(gui_resources.chain, (self._window.width / 1.5 * 4.0 / 10.0), 0,
                                                  batch=self._batch, group=self._background)
        self.chain_sprite3 = pyglet.sprite.Sprite(gui_resources.chain, (self._window.width / 1.5 * 6.0 / 10.0) - (
        gui_resources.chain.width / 2.0), 0, batch=self._batch, group=self._background)
        self.chain_sprite4 = pyglet.sprite.Sprite(gui_resources.chain, (self._window.width / 1.5 * 8.0 / 10.0) - (
        gui_resources.chain.width / 2.0), 0, batch=self._batch, group=self._background)
        ...
        point1 = PyPoint((self._window.width / 1.5 * 2.0 / 10.0) + (gui_resources.character_small.width / 4.0),
                         spritePosY + gui_resources.character_small.height / 30.0)
        point2 = PyPoint((self._window.width / 1.5 * 3.0 / 10.0) + (gui_resources.character_small.width / 4.0),
                         spritePosY + gui_resources.character_small.height / 30.0)
        point3 = PyPoint((self._window.width / 1.5 * 6.0 / 10.0) - (gui_resources.character_small.width / 8.0),
                         spritePosY + gui_resources.character_small.height / 30.0)
